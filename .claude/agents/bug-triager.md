...
Tickets: docs/tickets/BUG-NNN-<slug>.md. Known open P0/P1 list with file:line references is in docs/PROJECT-CONTEXT.md (hygiene section) and docs/product/BACKLOG.md.
