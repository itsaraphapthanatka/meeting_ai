...
# ภาษาไทยของ Meet เปลี่ยนคำเป็น "ออกจากการโทร" แล้ว ตัวเดิมหา "ออกจากสาย" อย่างเดียว
# จึงไม่เคยเจอ (BUG-070) — บอทอยู่ในห้องจริง อัดเสียงอยู่ แต่ระบบนับว่า "ยังไม่เข้าห้อง"
# ผลตอนนั้นคือหลังจาก JOIN_WAIT_SEC (120 วิ) leave_reason() จะเตะบอทออกจากห้องที่มันเข้าได้แล้ว
# วัดจาก log จริง 2026-09-19 14:08:30 — หน้าเว็บมี "ออกจากการโทร" ครบแต่ตรวจไม่เจอ
#
# ครอบคำที่ Meet เคยใช้และน่าจะใช้ต่อ + ชื่อไอคอน Material (`call_end`) ซึ่งอยู่ในปุ่มวางสาย
# เสมอไม่ว่าภาษาอะไร — หน้าห้องรอไม่มีปุ่มพวกนี้เลย จึงไม่เสี่ยงว่าจะตรวจเจอก่อนเข้าห้อง
MEET_IN = ('[aria-label*="Leave call"], [data-tooltip*="Leave call"],'
           ' [aria-label*="ออกจากการโทร"], [data-tooltip*="ออกจากการโทร"],'
           ' [aria-label*="ออกจากสาย"], [aria-label*="ออกจากการประชุม"],'
           ' button[aria-label*="ออกจาก"]')
