...
class Handler(BaseHTTPRequestHandler):
    ...
    def _job_scope(self) -> dict:
        ...
        if self.user:
            ...
            # owner_id ที่ส่งไปคือ "คนที่กำลังดู" ไม่ใช่ตัวกรองเจ้าของงานล้วน ๆ —
            # job_active() จะเห็นงานที่คนนี้สั่งเอง *หรือ* งานบนการประชุมที่คนนี้อ่านได้
            # (BACKLOG #37) ไม่งั้นงานที่เพื่อนร่วมทีมสั่งบนประชุม team ของเราจะหายไปเฉย ๆ
